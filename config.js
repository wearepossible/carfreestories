var config = {
    ...
    subtitle: 'The irresistible rise of people-friendly, clean air cities',
    intro: "<p>There are many reasons why cities around the world are moving to reduce traffic and cut the numbers of cars on roads. Partly it is to make way for active forms of travel like walking and cycling. And partly it is to produce more pleasant urban environments. Playing their part in the task of reducing carbon emissions and tackling the climate emergency is another reason.</p><p>Besides its severe impact on the climate emergency, transport emissions are also damaging for health reasons. Annually, around 1.35 million people are killed, with anything between 20 - 50 million more being injured - with many left with permanent disabilities. And then there is vehicles’ emission of a large amount of pollutants. According to the European Environment Agency, the most concerning of these are nitrogen oxides and particulate matter. Despite legal limits governed by European legislation, populations living in urban areas still breathe air that is above safe limits. Adults breathe around 15,000 litres of air per day. If that air is polluted the internal damage it can cause, rapidly accumulates.</p><p>The consequences are not yet fully understood. Worryingly, the range and scale of health impacts are constantly being found to be larger than previously thought. For the World Health Organisation (WHO), out of their estimate of 8 million premature deaths caused by air pollution around the world, half of these are due to ambient air pollution.. More recent research from three British universities and Harvard says that the picture could be much worse. Looking at the impact of fossil fuel related air pollution more in-depth they found that more than 8 million deaths could be attributed to it which accounted for nearly one in 5 of all premature deaths globally.</p><p>When responding to the pandemic, many towns and cities responded with measures designed to ensure enough space for social distancing. In many places this meant reducing traffic, widening walkways and rededicating roads to cyclists and pedestrians. In several places these measures added to, or grew out of already existing priorities to cut traffic, congestion and pollution. At a local level in the UK one range of initiatives became known as Low Traffic Neighbourhoods or ‘LTNs’. A small number of vocal opponents to LTNs generated a large public and media debate, creating the impression of widespread opposition.</p><p>As this report will show, this is nothing new. In fact it fits a long-established pattern. Time and time again whenever proposals are made to introduce controls on unlimited traffic and car use, there comes a tide of outrage from a vocal minority. What is little-known about however, is the accompanying well-trodden path as to what happens next. Typically when the measures are introduced, the negative consequences that drive many of the outcries do not materialise, people adapt their travelling habits, support gradually grows and the majority do not want to go back to how things were before.</p><p>Where LTNs are concerned, history is already repeating itself. Polling in the UK in late 2020 found that three times more people had a positive view of the measures than a negative one. In the mega-city of London 44 percent supported LTNs compared with just 21 percent opposing them. Sharpening the need for traffic reduction action, medical research is constantly revealing ever wider impacts from air pollution, including to mental health.</p><p>If there weren’t already enough reasons for our mega-cities to go car free (not to mention many other towns and cities radically reducing traffic) there are now even more. It helps to know that this journey is not new, but merely the next step of applying what we know to improve quality of life at street level. Of course some groups, such as those with personal mobility challenges, will still require vehicle access, but one of the best ways of meeting their needs will be clearing the roads of unnecessary cars. History has shown what works, and that whatever our fears, people are remarkably good at adapting to change. As many leave car culture behind, the path towards better towns and cities is looking clearer.",
